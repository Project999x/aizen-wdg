...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7573921917:AAHEh2C-k4xKAHCqzbZ1HpgZxrri9K7moO8")
...
START_PIC = os.environ.get("START_PIC", "https://envs.sh/LP6.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/LPV.jpg")
